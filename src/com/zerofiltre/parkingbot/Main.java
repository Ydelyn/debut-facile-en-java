...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       System.out.println("La différence entre la longueur et la largeur de la voiture est de: "+ difference);
       System.out.println("Le ratio entre la longueur et la largeur de la voiture est de: "+ ratio);
    }
}
